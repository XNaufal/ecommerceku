"""
Django settings for ecommerceku project.
...
SECRET_KEY = 'django-insecure-^v!_*qp+*$p5aan9ivxp-i38d$ijhqxqufkg@mp5$rf)$#ltbm'
...
WSGI_APPLICATION = 'ecommerceku.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'db_ecom',       # Nama database MySQL yang telah Anda buat
        'USER': 'root',   # Username MySQL Anda
        'PASSWORD': '@MySQLNFL2024',   # Password MySQL Anda
